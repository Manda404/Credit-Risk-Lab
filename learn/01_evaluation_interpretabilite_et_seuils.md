# Module 01 - Evaluation, Interpretabilite Et Seuils

Ce module regroupe trois chapitres complementaires :

- evaluation des modeles sur donnees desequilibrees ;
- interpretabilite avec SHAP, LIME, PDP et ICE ;
- optimisation du seuil de decision.

Dans un projet de scoring credit, ces notions arrivent apres la construction du
modele et avant la validation finale. Elles permettent de savoir si le modele
classe correctement, s'il est explicable et si son seuil est coherent avec le
risque metier.
