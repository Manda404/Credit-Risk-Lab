# Module 02 - Lift, Gain, Accumulation Et Deciles

Ce module explique comment lire la valeur metier d'un score. Dans un contexte
credit, le modele ne sert pas seulement a predire une classe : il sert a
prioriser les dossiers selon leur niveau de risque.

Les courbes Lift, Gain et les tables de deciles permettent de repondre a une
question concrete : combien de mauvais payeurs ou de cas positifs le modele
capture-t-il dans les premiers segments les plus risques ?
